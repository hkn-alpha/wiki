...
Finally, by the time you finish MP3, you'll have reached the halfway mark of the course, and begin work on MP4. In MP4, you work in groups of 3 and are assigned a CA/TA mentor for your group, who will be your helping hand in formulating a design for an Out-of-Order Tomasulo's or ERR (Explicit Register Renaming) processor. The MP will be divided into several checkpoints to develop various parts of the design. MP4 ends with a class-wide competition for the highest performance achievable on a processor using several benchmarks. Lean on your mentor CA/TA when you need help - that's what they're there for.
