...
The analysis of RF circuits across frequency ranges makes this course a suggested prerequisite for [ECE451](ECE451.md), Advanced Microwave Measurements. Other courses such as [ECE457](ECE457.md) (Microwave Devices and Circuits) also cover related material. Anyone looking to work in analog circuit design of any kind and especially RF circuits and systems will benefit from taking this class.
