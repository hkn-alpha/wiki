...
ECE220 is meant to be a first-time introduction to higher level programming languages like C and C++. It is meant to prepare students for classes like CS225 and ECE374 where a solid programming foundation is necessary. The first part of the course expands upon low-level LC-3 programming taught in ECE120. This includes .  Complex numbers are reviewed, including Euler’s formula and the exponential form of sine and cosine.  
