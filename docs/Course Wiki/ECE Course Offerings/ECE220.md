...
Taking ECE 220 opens up some higher level courses to highly motivated undergrads. Keep in mind you need to have completed your [junior eligibility requirements](https://ece.illinois.edu/academics/ugrad/advising-tips/junior225) first. [ECE408- Applied Parallel Programming](ECE408.md) is one such course that only requires ECE 220 as a prerequisite.
