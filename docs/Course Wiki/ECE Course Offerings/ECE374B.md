...
## 374B vs 374A
There are two versions of 374 offered at UIUC, section A and section B. They have different lectures, different discussions, different homeworks and exams, different grading. Most people consider the B section to be less difficult than the A section. One can check the [grade disparity](https://waf.cs.illinois.edu/discovery/grade_disparity_between_sections_at_uiuc/) to see the actual GPA differences. The B section lacks the emphasis on formal mathematical proof writing that the A section has. The A section and B section have different amounts of midterms and different grading policies. Read the [CS 374A page](../CS%20Course%20Offerings/ECE374A.md) as well to learn more about the differences.
