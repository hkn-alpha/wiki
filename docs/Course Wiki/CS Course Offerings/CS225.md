...
CS 225 often offers extra credit for submitting a part of the MP early.  This can be very useful for increasing your grade and is relatively easy given you start early on the MPs.  Starting early and working at a steady pace for this class can be very helpful in ensuring your success for this class, as leaving the MPs for the last day or few days can be a large task.
...
A final project is also offered for extra credit at the end of the semester to work on in a group.  You typically make a project utilizing some of the algorithms learned in the class, and details are posted towards the end of the semester.
...
CS225 is a prerequisite to many higher level ECE and CS courses, including [ECE/CS374](./CS374A.md) and other high level tech electives.  In addition to this, many students looking towards software development as a possible career will find that the concepts learned from this class will help greatly in competing for internships in this field.
...
- [C++ Reference Website](http://en.cppreference.com/)
